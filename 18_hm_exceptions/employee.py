...
from castom_exceptions import EmailAlreadyExistsException
...
class Employee:
    ...
    def __init__(self, name: str, salary_per_day: int, email):
        self.name = name
    ...
    def check_salary(self):
        '''counting amount of salary for this month using module datetime and self.salary_per_day'''
    ...
    def validate(self):
        '''
        checking email in document
        if yes -> raise custom except
        if no  -> continue
        '''
